...
export const ACTIVE_THEME: Theme = {
  id: "realestate-luxury-dark",
  name: "Real Estate Emerald Gold",
  emoji: "🏆",
  tagline: "Modern Dark & Elegant for Real Estate Video Creators",
  bg: "#080b11",
  card: "#0f1523",
  card2: "#0b101a",
  accent: "#10b981",
  ...
  accentGlow: true,
  cardRadius: 16,
  fontDisplay: "'SVN-Sonoma', 'Plus Jakarta Sans', 'Inter', sans-serif",
  fontBody: "'SVN-Sonoma', 'Plus Jakarta Sans', 'Inter', sans-serif",
  fontMono: "'JetBrains Mono', 'SFMono-Regular', Consolas, monospace",
  fontAccent: "'SVN-Sonoma', 'Plus Jakarta Sans', 'Inter', sans-serif",
  typeScaleBase: 16,
  typeScaleRatio: 1.25,
  btnRadius: 12,
  btnBorderWidth: 0,
